...
const UserProfileForm = ({ userProfileData, onSave, isLoading }: Props) => {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSave)} className="bg-gray-50 md:p-10 rounded-lg space-y-4">
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full">
                    ...
                    <FormField
                        control={form.control} name="country" render={({ field }) => (
                    ...
                    <FormField
                        control={form.control} name="addressLine1" render={({ field }) => (
                            <FormItem className="flex-1">
                                <FormLabel>
                                    AddressLine
                                </FormLabel>
